                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="UpdatePassword.php">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" required placeholder="Password" id="text" name="password" require>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" required placeholder="Repeat Password" id="text" name="repeatPassword" require>
                                        </div>
